...
var Input = {
  ...
  }// Changed colors and styling
canvas.style.backgroundColor = "black";
ctx.strokeStyle = "white"; // Changed from red to white
ctx.lineWidth = 3; // Increased font/line width
ctx.strokeStyle = "black"; // Set initial stroke color

// Create gradient for the drawing
var gradient = ctx.createLinearGradient(0, 0, canvas.width, canvas.height);
gradient.addColorStop(0, "white");
gradient.addColorStop(1, "white");
ctx.strokeStyle = gradient; // Apply black and white gradient
